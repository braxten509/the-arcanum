...
from .proof_contract import check_proof_contract
from .proof_runtime import clear_evidence, replay
...
def _check_lesson(section, lesson, where, step_ids):
    ...
    if teaches and not blocks and not steps:
...
def _check_section(section, where, step_ids, urls, allow_guided=False):
    ...
    for lesson in lessons:
        _check_lesson(section, lesson, where, step_ids)
