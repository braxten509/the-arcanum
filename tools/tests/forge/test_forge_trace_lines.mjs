...
const merged = mergeForgeTraceLines([
  ...
  `AI VALIDATOR CALL START [${epoch(12, 41, 1).toFixed(3)}] › prerequisite completeness s05 › codex-cli gpt-5.6-sol`,
  `AI VALIDATOR CALL COMPLETE [${epoch(12, 41, 9).toFixed(3)}] (PASS) › prerequisite completeness s05 › codex-cli gpt-5.6-sol`,
...
assert.deepEqual(merged.map((line) => line.slice(0, 8)), [
  ...
  stamp(12, 41, 9), stamp(12, 42, 23), stamp(12, 43, 26), stamp(12, 44, 39),
  stamp(12, 45, 59), stamp(12, 46, 6),
]);
