...
def standard_phase_registry() -> PhaseRegistry:
    ...
    entries = (
        ...
        PhaseDefinition(3, "sections", "Sections", _phase3, _phase3_commands,
                        ("tools/validate_phase3.py",), unit_kind="section", version=1,
                        capabilities=("section-authoring", "section-validation", "warm-repair")),
        PhaseDefinition(4, "minigames", "Minigames", _authored_bank(4),
                        _validator(4, phase_only=True), ("tools/validate_tome.py",), version=1,
                        capabilities=("practice-bank", "phase-only-validation")),
        PhaseDefinition(5, "economy", "Economy", _authored_bank(5),
                        _validator(5, phase_only=True), ("tools/validate_tome.py",), version=1,
                        capabilities=("economy-policy", "phase-only-validation")),
        PhaseDefinition(6, "cosmetics", "Cosmetics", _authored_bank(6),
                        _validator(6, phase_only=True), ("tools/validate_tome.py",), version=1,
                        capabilities=("visual-system", "phase-only-validation")),
        PhaseDefinition(7, "validate", "Validate", _phase7, _phase7_commands,
                        ("tools/validate_phase3.py", "tools/smoke_tome.py",
                         "tools/gen_mastery_labs.py"), version=1,
                        capabilities=("variant-generation", "strict-validation", "live-smoke")),
        PhaseDefinition(8, "student-review", "Student review", _phase8,
                        _phase8_commands,
                        ("tools/validate_phase3.py", "tools/smoke_tome.py",
                         "tools/validate_mastery_review.py"), final=True, version=1,
                        capabilities=("semantic-review", "strict-validation", "live-smoke")),
    )
