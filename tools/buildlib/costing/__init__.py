"""Verified vendor list prices used for CLI API-equivalent accounting."""

PRICING_VERSION = "openai-anthropic-standard-2026-07-21"
PRICING_SOURCE = ("https://developers.openai.com/api/docs/pricing ; "
                  "https://www.anthropic.com/pricing")

# USD per one million tokens. Unknown models stay unpriced; accounting must
# never invent a rate. Sonnet 5 introductory pricing is active through
# 2026-08-31, which is why the pricing version above includes a date.
MODEL_PRICES = {
...
GPT_MODELS = frozenset(model for model in MODEL_PRICES if model.startswith("gpt-"))
