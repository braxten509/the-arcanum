...
`tome-authoring/` is a REFERENCE, not a script to dump straight into output. Work in
phases (§6), pulling in each section as its phase needs it (`§N` = the file starting
